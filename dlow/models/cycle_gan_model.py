...
#        visual_names_B = ['real_B', 'fake_A', 'rec_B']
    ...
    def set_input(self, input, sign):
        ...
        if self.isTrain:
            ...
            self.add_item = self.netDeConv(Variable(torch.FloatTensor(self.random_number).view(1,4,1,1)).cuda(self.gpu_ids[0]))
...
# #            self.loss_G_A_Classification0to1 = self.criterionGAN(self.netD_A_Classification0to1.forward(self.fake_B), True)*lambda_GA_classification_0to1
    ...
    def optimize_parameters(self):
        ...
        gnorm_DeConv = torch.nn.utils.clip_grad_norm_(self.netDeConv.parameters(), self.opt.max_gnorm)
