...
def start_training(target_domain: str, model_name: str, pretrained: bool, params):
    ...
    train_loader, val_loader, test_loader, target_domain = split_df_into_loaders(dataset["df"],
...
for study_file in studies:
    ...
    study = optuna.load_study(storage=f"sqlite:///{os.path.join(study_dir, study_file)}", study_name=study_name)
